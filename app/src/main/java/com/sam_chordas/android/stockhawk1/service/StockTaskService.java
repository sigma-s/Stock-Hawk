...
public class StockTaskService extends GcmTaskService{
  ...
  private StockHistoricalData stockHistoricalData;
  ...
  public int onRunTask(TaskParams params){
    ...
    //symbolList.addAll(Arrays.asList("YHOO","AAPL","GOOG","MSFT"));
    stockHistoricalData = new StockHistoricalData(this);
    ...
    if (params.getTag().equals(StockIntentService.ACTION_INIT) || params.getTag().equals(TAG_PERIODIC)){
      ...
      if (initQueryCursor.getCount() == 0 || initQueryCursor == null){
        ...
        for (int i = 0; i < initQueryCursor.getCount(); i++){
          String symbol = initQueryCursor.getString(initQueryCursor.getColumnIndex(StockIntentService.EXTRA_SYMBOL));
    ...
    if (urlStringBuilder != null) {
      ...
      for (String symbol : symbolList) {
        ...
        try {
          stockHistoricalData.onRunTask(new Bundle(args),mContext);
        } catch (Exception e) {
