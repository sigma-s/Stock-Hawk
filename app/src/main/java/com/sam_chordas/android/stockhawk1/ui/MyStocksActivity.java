...
import com.sam_chordas.android.stockhawk1.rest.QuoteCursorAdapter;
import com.sam_chordas.android.stockhawk1.rest.RecyclerViewItemClickListener;
import com.sam_chordas.android.stockhawk1.rest.Utils;
import com.sam_chordas.android.stockhawk1.service.StockIntentService;
import com.sam_chordas.android.stockhawk1.service.StockTaskService;
import com.google.android.gms.gcm.GcmNetworkManager;
import com.google.android.gms.gcm.PeriodicTask;
import com.google.android.gms.gcm.Task;
import com.melnykov.fab.FloatingActionButton;
import com.sam_chordas.android.stockhawk1.touch_helper.SimpleItemTouchHelperCallback;
import com.sam_chordas.android.stockhawk1.widget.StockWidgetProvider;
...
public class MyStocksActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
                ...
                @Override public void onInput(MaterialDialog dialog, CharSequence input) {
                  ...
                  if(c!=null && isAlphaNumeric(symbol)) {
                    if (c.getCount() != 0) {
                      ...
                      mServiceIntent.putExtra(StockIntentService.EXTRA_SYMBOL, input.toString().toUpperCase());
                      startService(mServiceIntent);
                      updateStocksWidget();
                    }
                  } else {
  ...
  private void updateStocksWidget(){
    ...
    if(ids.length > 0) {
      ...
      appWidgetManager.notifyAppWidgetViewDataChanged(ids, R.id.stock_widget);
    }
  }
